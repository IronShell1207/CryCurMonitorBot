...
def info_start(lang):
    if lang == "rus":
        ...
        К примеру тебе нужно знать, когда биткоин возьмет отметку в $40.000. Для этого нажимаешь кнопку 'Создать 📊' и присылаешь боту либо название монеты 'BTC' либо пару 'BTC/USDT'
